...
export const studyOrProjectOption = [
  { value: "1", label: "프로젝트" },
  { value: "2", label: "스터디" },
];

export const onlineOrOfflineOption = [
  { value: "on", label: "온라인" },
  { value: "off", label: "오프라인" },
];

export const recruitsOption = [
...
export const expectedPeriodOption = [
...
export const positionsOption: { label: string; value: Position }[] = [
  { value: "ALL", label: "전체" },
...
export const positionsExceptAllOption = [
  { value: "FE", label: "프론트엔드" },
  { value: "BE", label: "백엔드" },
  { value: "DE", label: "디자이너" },
  { value: "IOS", label: "IOS" },
...
export const workExperienceOption = [
  { value: "n", label: "0년" },
  { value: "1", label: "1년" },
  { value: "2", label: "2년" },
  { value: "3", label: "3년" },
